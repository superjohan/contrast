...
class ContrastViewController: UIViewController, ContrastChannelViewDelegate {
	...
	private func createIntroLabel() {
		...
		attributedString.addAttribute(NSUnderlineStyleAttributeName, value: NSUnderlineStyle.StyleThick.rawValue, range: NSMakeRange(0, "Contrast".lengthOfBytesUsingEncoding(NSUTF8StringEncoding)))
